 ...
 * View of the model 
 */
public class ReturnView implements Observer
{
  ...
  private ReturnController cont       = null;
  ...
  public ReturnView(  RootPaneContainer rpc,  MiddleFactory mf, int x, int y  )
  {
    try                                           // 
    {      
  ...
  public void setController( ReturnController c )
  {
    cont = c;
  }
  ...
  {
    ReturnModel model  = (ReturnModel) modelC;
